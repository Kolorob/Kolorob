...
//			textAsk.setTextSize(17);
	...
	public static void showMessagesize(final Context c, final String title,
								   final String body,float size1,float size2) {
		...
		final TextView bodys = (TextView) promptView.findViewById(R.id.body);
		final ImageView okay=(ImageView)promptView.findViewById(R.id.okay);
header.setTextSize(size1);
		bodys.setTextSize(size2);
		header.setText(title);
		bodys.setText(body);
