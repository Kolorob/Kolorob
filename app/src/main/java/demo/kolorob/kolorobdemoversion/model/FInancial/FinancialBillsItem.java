 ...
 */
public class FinancialBillsItem {
    ...
    public FinancialBillsItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark, String refNum) {
        this.nodeId = nodeId;
    ...
    public static FinancialBillsItem parseFinancialBillsItem(JSONObject jo) throws JSONException {
