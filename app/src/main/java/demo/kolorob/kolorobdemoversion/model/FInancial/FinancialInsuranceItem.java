 ...
 */
public class FinancialInsuranceItem {
    ...
    public FinancialInsuranceItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark, String refNum) {
        this.nodeId = nodeId;
    ...
    public static FinancialInsuranceItem parseFinancialInsuranceItem(JSONObject jo) throws JSONException {
