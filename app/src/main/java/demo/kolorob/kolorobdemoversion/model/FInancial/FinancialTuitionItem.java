 ...
 */
public class FinancialTuitionItem {
    ...
    public FinancialTuitionItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark, String refNum) {
        this.nodeId = nodeId;
    ...
    public static FinancialTuitionItem parseFinancialTuitionItem(JSONObject jo) throws JSONException {
