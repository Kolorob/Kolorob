 ...
 */
public class FinancialPaymentItem {
    ...
    public FinancialPaymentItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark, String refNum) {
        this.nodeId = nodeId;
    ...
    public static FinancialPaymentItem parseFinancialPaymentItem(JSONObject jo) throws JSONException {
