 ...
 */
public class FinancialLoanItem {
    ...
    public FinancialLoanItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark, String refNum) {
        this.nodeId = nodeId;
    ...
    public static FinancialLoanItem parseFinancialLoanItem(JSONObject jo) throws JSONException {
