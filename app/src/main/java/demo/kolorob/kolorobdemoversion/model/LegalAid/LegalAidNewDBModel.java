...
public class LegalAidNewDBModel implements Serializable {
    ...
    public LegalAidNewDBModel(int legalid, String nameen, String namebn, String servicetype, String lat, String lon, String houseno, String block, String area, String policestation, String node_email, String ward, String road, String node_contact, String otherinfo, String offday, String closetime, String openingtime, int categoryId, String refnumm, String subcat, String ratings) {
