 ...
 * Created by Mazhaul Islam on 10/2/2016.
 */
public class FinancialPaymentAdapter extends BaseAdapter
{
    Activity context;
    ...
    public FinancialPaymentAdapter(Activity context, String[] service_name,String[] yes_no,String[] costs,String[] remark) {
        super();
