...
public class EducationCourseFee extends BaseAdapter
{
    ...
    public EducationCourseFee(Activity context, String[] course_name,String[] course_duration,String[] course_admission_time,String[] edu_course_cost,String[] edu_course_type) {
        super();
