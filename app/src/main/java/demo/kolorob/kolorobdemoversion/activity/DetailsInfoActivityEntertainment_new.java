...
public class DetailsInfoActivityEntertainment_new extends Activity  {
...
//        itemBreakTime.setText("  বিরতির সময়: "+entertainmentServiceProviderItem.getBreaktime());
        ...
        if(!entertainmentServiceProviderItem.getNodeEmail().equals(""))
            concateBasic(" ইমেইল : ",entertainmentServiceProviderItem.getNodeEmail());

        if(!entertainmentServiceProviderItem.getNodeWebsite().equals(""))
            concateBasic(" ওয়েবসাইট : ",entertainmentServiceProviderItem.getNodeWebsite());


        if(!entertainmentServiceProviderItem.getNodeFacebook().equals(""))
            concateBasic(" ফেইসবুক: ",entertainmentServiceProviderItem.getNodeFacebook());
...
//        landmark.setText(" কাছাকাছি পরিচিত স্থান: "+entertainmentServiceProviderItem.getRoad());
        ...
        EntertainmentBookTable entertainmentBookTable =new EntertainmentBookTable(DetailsInfoActivityEntertainment_new.this);
        EntertainmentFieldTable entertainmentFieldTable = new EntertainmentFieldTable(DetailsInfoActivityEntertainment_new.this);
        EntertainmentFitnessTable entertainmentFitnessTable = new EntertainmentFitnessTable(DetailsInfoActivityEntertainment_new.this);
        EntertainmentTheatreTable entertainmentTheatreTable =new EntertainmentTheatreTable(DetailsInfoActivityEntertainment_new.this);
        ...
        kivabejaben.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(AppUtils.isNetConnected(getApplicationContext())  && AppUtils.displayGpsStatus(getApplicationContext())) {
                    ...
                    AppUtils.showSettingsAlert(DetailsInfoActivityEntertainment_new.this);

                }
                else
                {
                    AlertDialog alertDialog = new AlertDialog.Builder(DetailsInfoActivityEntertainment_new.this, AlertDialog.THEME_HOLO_LIGHT).create();
