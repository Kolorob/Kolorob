...
//                            Toast.LENGTH_LONG).show();
    ...
    public void sendReviewToServer()
    {
        ...
        String url = "http://kolorob.net/kolorob-new-demo/api/sp_rating2/"+governmentNewItem.getGovid()+"?"+"phone=" +phone_num +"&name=" +uname + "&rating="+rating+"&username="+username+"&password="+password+"";
