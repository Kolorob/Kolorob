...
//                            Toast.LENGTH_LONG).show();
    ...
    public void sendReviewToServer()
    {
        ...
        String url = "http://kolorob.net/kolorob-new-demo/api/sp_rating/"+governmentNewItem.getGovid()+"?"+"phone=" +phone_num +"&name=" +uname +"&review=" +comment2+ "&rating="+rating+"&username="+username+"&password="+password+"";
