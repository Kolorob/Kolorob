...
//
    ...
    private void loadSomeData() {
        ...
        AreaItem areaItem = new AreaItem("Mirpur 12","মিরপুর ১২");
        ...
        areaItem = new AreaItem("Mirpur 10","মিরপুর ১০");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Mirpur 13","মিরপুর ১৩");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Mirpur 14","মিরপুর ১৪");
        areaItems.add(areaItem);
        ...
        areaItem = new AreaItem("Mirpur 11","মিরপুর ১১");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Bauniabadh","বাউনিয়াবাধ");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Mirpur 6","মিরপুর ৬");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Mirpur 7","মিরপুর ১৩");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Eastern Housing","ইস্টার্ন হাউজিং");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Albodi","আলবদি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Pallabi","পল্লবী");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Albodi Rupnagar Tinshed","আলবদী রূপনগর টিনশেড");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Mirpur 2","মিরপুর ২");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Mirpur 6","মিরপুর ৬");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Rupnagar","রূপনগর");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Mirpur 1","মিরপুর ১");
        areaItems.add(areaItem);
        areaItem = new AreaItem("North Bishil","নর্থ বিশিল");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Baksnagar","বাক্সনগর");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Nobabaer Bag","নবাবের বাগ");
        areaItems.add(areaItem);
        areaItem = new AreaItem("BISF Staff Quarter","বিআইএসএফ স্ট্যাফ কোয়ার্টার");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Bagbari","বাগবাড়ি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Harirampur","হরিরামপুর");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Jahurabad","জহুরাবাদ");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Bazarpara","বাজারপাড়া");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Bordhonbari","বর্ধনবাড়ি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Golartek","গলারটেক");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Choto Diabari","ছোট দিয়াবাড়ি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Coat Bari","কোটবাড়ি");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Gabtoli Jamidarbari","গাবতলী জমদারবাড়ি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Gabtoli 1st Colony","গাবতলী ফার্স্ট কলনি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Gabtoli 2nd Colony","গাবতলী সেকেন্ড কলনি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Gabtoli 3rd Colony","গাবতলী থার্ড কলনি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Goidartek","গৈদারটেক");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Kallyanpur","কল্যাণপুর ");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Admmed Nagar","আহমেদ নগর");
        areaItems.add(areaItem);
        areaItem = new AreaItem("South Bishil","সাউথ বিশিল");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Shah Ali Bag","শাহ আলী বাগ");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Kalwala Para","কলওয়্যালা পাড়া");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Paikpara Staff Quarter","পাইকপাড়া স্ট্যাফ কোয়ার্টার");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Education Board Staff Quarter","এডুকেশন বোর্ড স্ট্যাফ কোয়ার্টার");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Tolarbag","তলারবাগ");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Borobag","বড়বাগ");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Pirer Bag","পীরের বাগ");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Kazi para","কাজীপাড়া");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Shewrapara","শেওড়াপাড়া");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Vashantek","ভাষানটেক");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Albodortek","আলবদরটেক");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Damalkot","দামালকোট");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Lalasorai","লালাসরাই");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Matikata","মাটিকাটা");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Manikdi","মানিকদি");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Balughat","বালুঘাট");
        areaItems.add(areaItem);
        areaItem = new AreaItem("Baigertek","বাইগারটেক");
        areaItems.add(areaItem);
        ...
        areaItems = new ArrayList<AreaItem>();
        areaItem = new AreaItem("Ibrahimpur","ইব্রাহীমপুর");
        areaItems.add(areaItem);
