...
public class DetailsInfoActivityReligious extends AppCompatActivity {
    ...
    ReligiousNewDBModel religiousServiceProviderItemNew;
    //ArrayList<ReligiousDetailsItem> religiousDetailsItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != intent) {
            religiousServiceProviderItemNew = (ReligiousNewDBModel) intent.getSerializableExtra(AppConstants.KEY_DETAILS_RELIGIOUS);
        ...
        SharedPreferences settings = DetailsInfoActivityReligious.this.getSharedPreferences("prefs", 0);
...
//        upperText.setLayoutParams(params_upperText);
        ...
        ups_text.setText(religiousServiceProviderItemNew.getNamebn());
        ...
        CheckConcate("ঠিকানা", concatenateAddress(religiousServiceProviderItemNew.getHouseno(), religiousServiceProviderItemNew.getRoad(), religiousServiceProviderItemNew.getBlock(), religiousServiceProviderItemNew.getAreabn()));
        ...
        CheckConcate("সাপ্তাহিক বন্ধ", religiousServiceProviderItemNew.getOffday());
...
//        });
        ...
        CommentTable commentTable = new CommentTable(DetailsInfoActivityReligious.this);


        commentItems = commentTable.getAllFinancialSubCategoriesInfo(String.valueOf(religiousServiceProviderItemNew.getReligousid()));
        ...
        comments.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (SharedPreferencesHelper.getifcommentedalready(DetailsInfoActivityReligious.this, String.valueOf(religiousServiceProviderItemNew.getReligousid()), uname).equals("yes") || inc > 0) {
                    if (SharedPreferencesHelper.getifcommentedalready(DetailsInfoActivityReligious.this, String.valueOf(religiousServiceProviderItemNew.getReligousid()), uname).equals("yes") && inc == 0) {
                        AlertMessage.showMessage(con, "দুঃখিত",
                                "কমেন্ট দেখতে দয়া করে তথ্য আপডেট করুন");

                    } else {
                        if (SharedPreferencesHelper.getifcommentedalready(DetailsInfoActivityReligious.this, String.valueOf(religiousServiceProviderItemNew.getReligousid()), uname).equals("yes")) {
                            ToastMessageDisplay.setText(con,
                                    "আপনার করা কমেন্ট দেখতে দয়া করে তথ্য আপডেট করুন");
                            ToastMessageDisplay.showText(con);
                        }
                        LayoutInflater layoutInflater = LayoutInflater.from(DetailsInfoActivityReligious.this);
                        final View promptView = layoutInflater.inflate(R.layout.comment_popup, null);
                        final Dialog alertDialog = new Dialog(DetailsInfoActivityReligious.this);
...
//                    final TextView textView=(TextView)promptView.findViewById(R.id.header);
                        ...
                        try {
                            int ratings = Integer.parseInt(religiousServiceProviderItemNew.getRatings());
                        ...
                        Double screenSize = AppUtils.ScreenSize(DetailsInfoActivityReligious.this);
                        if (screenSize > 6.5) {
...
//                    textView.setVisibility(View.GONE);
                    ...
                    if (SharedPreferencesHelper.isTabletDevice(DetailsInfoActivityReligious.this))
                    ...
                    yes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            alertDialog.cancel();
                            String register = SharedPreferencesHelper.getNumber(DetailsInfoActivityReligious.this);
                            phone_num = register;
        ...
        right_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (religiousServiceProviderItemNew.getNode_email().equals("null") || religiousServiceProviderItemNew.getNode_email().equals("")) {
                    AlertMessage.showMessage(con, "ই মেইল করা সম্ভব হচ্ছে না",
                            "ই মেইল আই ডি পাওয়া যায়নি");
                } else {
                    Helpes.sendEmail(DetailsInfoActivityReligious.this, religiousServiceProviderItemNew.getNode_email());
                }
            }
        });
//
        ...
        middle_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!religiousServiceProviderItemNew.getNode_contact().equals("null")) {
                    callIntent1.setData(Uri.parse("tel:" + religiousServiceProviderItemNew.getNode_contact()));
                    if (checkPermission())
        ...
        distance_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AppUtils.isNetConnected(getApplicationContext()) && AppUtils.displayGpsStatus(getApplicationContext())) {
                    ...
                    String lat = religiousServiceProviderItemNew.getLat().toString();
                    // double latitude = Double.parseDouble(lat);
                    String lon = religiousServiceProviderItemNew.getLon().toString();
                    // double longitude = Double.parseDouble(lon);
                    String name = religiousServiceProviderItemNew.getNamebn().toString();
                    String node = String.valueOf(religiousServiceProviderItemNew.getReligousid());
                    ...
                    Intent intentJ = new Intent(DetailsInfoActivityReligious.this, MapFragmentRouteOSM.class);
...
//                                        rating=Float.parseFloat(ratingH.getString("avg"));
        try {
            ratingBar.setRating(Float.parseFloat(religiousServiceProviderItemNew.getRatings()));
        } catch (Exception e) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AppUtils.isNetConnected(getApplicationContext())) {
                    ...
                    ToastMessageDisplay.setText(DetailsInfoActivityReligious.this, "দয়া করে ইন্টারনেট চালু করুন।");
//                    Toast.makeText(this, "আপনার ফোনে ইন্টারনেট সংযোগ নেই। অনুগ্রহপূর্বক ইন্টারনেট সংযোগটি চালু করুন। ...",
//                            Toast.LENGTH_LONG).show();
                    ToastMessageDisplay.showText(DetailsInfoActivityReligious.this);
                }
    ...
    public void sendReviewToServer() {
        ...
        String uname2 = SharedPreferencesHelper.getUname(DetailsInfoActivityReligious.this);
        ...
        String url = "http://kolorob.net/kolorob-new-demo/api/sp_rating2/" + religiousServiceProviderItemNew.getReligousid() + "?" + "phone=" + phone_num + "&name=" + uname  + "&rating=" + rating + "&username=" + username + "&password=" + password + "";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (response.equals("true")) {
                                SharedPreferencesHelper.setifcommentedalready(DetailsInfoActivityReligious.this, String.valueOf(religiousServiceProviderItemNew.getReligousid()), uname, "yes");

                                AlertMessage.showMessage(DetailsInfoActivityReligious.this, "মতামতটি গ্রহন করা হয়েছে",
                                        "মতামত প্রদান করার জন্য আপনাকে ধন্যবাদ ");
                            } else
                                AlertMessage.showMessage(DetailsInfoActivityReligious.this, "মতামতটি গ্রহন করা হয় নি",
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DetailsInfoActivityReligious.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DetailsInfoActivityReligious.this);
    ...
    public void requestToRegister() {
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentPhoneRegistration = new Intent(DetailsInfoActivityReligious.this, PhoneRegActivity.class);
                alertDialog.cancel();
