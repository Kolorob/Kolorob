...
public class FinancialTaxTable {
    private static final String TAG = FinancialTaxTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_TAX;
    ...
    public FinancialTaxTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialTaxItem financialTaxItem) {
        return insertItem(
                financialTaxItem.getNodeId(),
                financialTaxItem.getServicename(),
                financialTaxItem.getYn(),
                financialTaxItem.getServicecost(),
                financialTaxItem.getServiceremark(),
                financialTaxItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialTaxItem> getFinancialTax(String idenId) {
        ArrayList<FinancialTaxItem> TaxList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                TaxList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialTaxItem cursorToSubCatList(Cursor cursor) {
        ...
        return new FinancialTaxItem(_nodeId,
