 ...
 */
public class FinancialBillsTable {
    private static final String TAG = FinancialBillsTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_BILLS;
    ...
    public FinancialBillsTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialBillsItem financialBillsItem) {
        return insertItem(
                financialBillsItem.getNodeId(),
                financialBillsItem.getServicename(),
                financialBillsItem.getYn(),
                financialBillsItem.getServicecost(),
                financialBillsItem.getServiceremark(),
                financialBillsItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialBillsItem> getFinancialBills(String idenId) {
        ArrayList<FinancialBillsItem> BillList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                BillList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialBillsItem cursorToSubCatList(Cursor cursor) {
        ...
        return new FinancialBillsItem(_nodeId,
