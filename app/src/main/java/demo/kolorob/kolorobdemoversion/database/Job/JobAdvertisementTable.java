...
//
//    private static final String KEY_FORM_DATE = "_contact_person_designation"; //
//    private static final String KEY_POSITION = "_contact_no"; //
//    private static final String KEY_INSTITUTION_NAME = "_email_address"; //
//    private static final String KEY_INSTITUTION_NAME_BANGLA = "_website_link"; //
//    private static final String KEY_POST_DATE = "_fb_link"; //
//    private static final String KEY_APPLICATION_LAST_DATE = "_registered_with"; //
//    private static final String KEY_LOCATION = "_registration_no"; //
//    private static final String KEY_POST_TYPE = "_additional_info"; //
//    private static final String KEY_JOB_RESPONSIBILITY = "_area"; //
//    private static final String KEY_REQUIRED_EXPERIENCE = "_address"; //
//    private static final String KEY_START_SALARY = "_latitude"; //
//    private static final String KEY_END_SALARY = "_longitude"; //
//
//
//    private static final String KEY_JOB_SUBCATEGORY_ID = "_job_subcategory_id"; // 2 - text*/
//    private static final String KEY_ID = "_id";
...
//        return false;
//    }
//    public ArrayList<JobServiceProviderItem> Jobnames(int cat_id,String head,String a,String place) {
//        String subcatnames=null;
//        subcatnames=a;
//
//        ArrayList<JobServiceProviderItem> nameslist=new ArrayList<>();
//
//        SQLiteDatabase db = openDB();
//
//        Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE " + KEY_CATEGORY_ID + "=" + cat_id
//                + " AND "+KEY_AREA+" = '"+place+"'"  + " AND "+ KEY_JOB_SUBCATEGORY_ID + "=" + "(SELECT _sub_cat_id from " + DatabaseHelper.SUB_CATEGORY + " WHERE _sub_cat_name = '"+subcatnames+"')", null);
//
//
//        if (cursor.moveToFirst()) {
//            do {
...
//
//        return new JobAdvertisementItem(_identifierId, _serviceProviderId, _jobSubCategoryId,
