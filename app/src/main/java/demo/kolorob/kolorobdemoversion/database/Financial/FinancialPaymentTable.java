 ...
 */
public class FinancialPaymentTable {
    private static final String TAG = FinancialPaymentTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_PAYMENT;
    ...
    public FinancialPaymentTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialPaymentItem financialPaymentItem) {
        return insertItem(
                financialPaymentItem.getNodeId(),
                financialPaymentItem.getServicename(),
                financialPaymentItem.getYn(),
                financialPaymentItem.getServicecost(),
                financialPaymentItem.getServiceremark(),
                financialPaymentItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialPaymentItem> getFinancialPayment(String idenId) {
        ArrayList<FinancialPaymentItem> PayList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                PayList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialPaymentItem cursorToSubCatList(Cursor cursor) {
        ...
        return new FinancialPaymentItem(_nodeId,
