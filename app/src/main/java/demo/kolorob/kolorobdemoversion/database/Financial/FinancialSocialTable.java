 ...
 */
public class FinancialSocialTable {
    private static final String TAG = FinancialSocialTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_SOCIAL;
    ...
    public FinancialSocialTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialSocialItem financialSocialItem ) {
        return insertItem(
                financialSocialItem.getNodeId(),
                financialSocialItem.getServicename(),
                financialSocialItem.getYn(),
                financialSocialItem.getServicecost(),
                financialSocialItem.getServiceremark(),
                financialSocialItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialSocialItem> getFinancialSocial(String idenId) {
        ArrayList<FinancialSocialItem> SocialList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                SocialList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialSocialItem cursorToSubCatList(Cursor cursor) {
