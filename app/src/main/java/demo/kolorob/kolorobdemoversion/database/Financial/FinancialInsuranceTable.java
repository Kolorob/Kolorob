 ...
 */
public class FinancialInsuranceTable {
    private static final String TAG = FinancialInsuranceTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_INSURANCE;
    ...
    public FinancialInsuranceTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialInsuranceItem financialInsuranceItem) {
        return insertItem(
                financialInsuranceItem.getNodeId(),
                financialInsuranceItem.getServicename(),
                financialInsuranceItem.getYn(),
                financialInsuranceItem.getServicecost(),
                financialInsuranceItem.getServiceremark(),
                financialInsuranceItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialInsuranceItem> getInsurance(String idenId) {
        ArrayList<FinancialInsuranceItem> InsuranceList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                InsuranceList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialInsuranceItem cursorToSubCatList(Cursor cursor) {
        ...
        return new FinancialInsuranceItem(_nodeId,
