 ...
 */
public class FinancialLoanTable {
    private static final String TAG = FinancialLoanTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_LOAN;
    ...
    public FinancialLoanTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialLoanItem financialLoanItem) {
        return insertItem(
                financialLoanItem.getNodeId(),
                financialLoanItem.getServicename(),
                financialLoanItem.getYn(),
                financialLoanItem.getServicecost(),
                financialLoanItem.getServiceremark(),
                financialLoanItem.getRefNum()
        );
    }
    ...
    public ArrayList<FinancialLoanItem> getFinancialLoan(String idenId) {
        ArrayList<FinancialLoanItem> LoanList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                LoanList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialLoanItem cursorToSubCatList(Cursor cursor) {
        ...
        return new FinancialLoanItem(_nodeId,
