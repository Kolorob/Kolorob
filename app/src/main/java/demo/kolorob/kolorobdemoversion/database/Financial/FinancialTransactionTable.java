...
public class FinancialTransactionTable {
    private static final String TAG = FinancialTransactionTable.class.getSimpleName();
    private static final String TABLE_NAME = DatabaseHelper.FINANCIAL_SERVICE_TRANSACTION;
    ...
    private static  final String KEY_FIN_SERVICE_PRONAME="_serviceprovidername";
    private static final String KEY_KEY_FIN_REF_NUM= "_refNum"; //

    private Context tContext;

    public FinancialTransactionTable(Context context) {
        tContext = context;
        createTable();
    }
    ...
    public long insertItem(FinancialTransactionItem financialTransactionItem) {
        return insertItem(
                financialTransactionItem.getNodeId(),
                financialTransactionItem.getServicename(),
                financialTransactionItem.getYn(),
                financialTransactionItem.getServicecost(),
                financialTransactionItem.getServiceremark(),
                financialTransactionItem.getServiceprovidername(),
                financialTransactionItem.getRefNum()
        );
    }

    private long insertItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark,String serviceprovidername, String refNum) {
        ...
        rowValue.put(KEY_FIN_SERVICE_PRONAME,serviceprovidername);
    ...
    private long updateItem(String nodeId, String servicename, String yn, String servicecost, String serviceremark,String serviceprovidername, String refNum) {
    ...
    public ArrayList<FinancialTransactionItem> getFinancialTransaction(String idenId) {
        ArrayList<FinancialTransactionItem> TransactionList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                TransactionList.add(cursorToSubCatList(cursor));
            } while (cursor.moveToNext());
        }
        cursor.close();
        closeDB();
    ...
    private FinancialTransactionItem cursorToSubCatList(Cursor cursor) {
        ...
        String _serviceprovidername=cursor.getString(5);
        String _refNum = cursor.getString(6);

        return new FinancialTransactionItem(_nodeId,
                _servicename, _yn, _servicecost,_serviceremark,_serviceprovidername,_refNum);
